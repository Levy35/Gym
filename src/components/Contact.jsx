    ...
    <div className="min-h-screen flex flex-col items-center justify-center md:mx-32 mx-5 mt-10">
      <div className="flex flex-col md:flex-row justify-between w-full">
        ...
        <div className="flex flex-row items-center w-full md:w-2/4 my-5">
          <iframe
            title="Location"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d918.2578810831742!2d-88.52018223043711!3d16.659767799006787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f5df30043f3b311%3A0x47efabef9cf6d716!2sLevi%20Jxdn!5e1!3m2!1sen!2sbz!4v1721160466637!5m2!1sen!2sbz"
            width="600"
            height="450"
            style={{ border: 0 }}
            allowFullScreen=""
